    ...
    public function news_response(){
             ...
             foreach ($result as $key => $val) 
             {
               $str.="<item>
                          ...
                          <Url><![CDATA[".$this->configstr['host']."plus/view.php?aid={$val['id']}]]></Url>
                     </item>";
              }     
             $str.="</Articles>";
    ...
    */
    public function mu_response($keyword=''){//音乐回复
         if($this->postData->MsgType =="voice" || $keyword =="音乐"){
            ...
            $MusicURL = $this->configstr['host'].'weixin/music/More.mp3';          
            $HQMusicUrl =$this->configstr['host'].'weixin/music/More.mp3';
